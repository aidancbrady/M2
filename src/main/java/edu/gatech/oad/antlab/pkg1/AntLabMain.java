 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Aidan Brady");
		  toPrint += p1.toString("abrady30");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Priscylla Snow");
		  toPrint += p2.toString("mdo30");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Yuuna Hoshi");
		  toPrint += p3.toString("yhoshi3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Valerie Fanelle");
          toPrint += p4.toString("vfanelle3");
          //Person5 replace P5 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Lyn Phan");
          toPrint += p5.toString("dphan8");
